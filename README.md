...
|---|---:|---:|---:|---:|
| Mobility | Accuracy | 0.581 | 0.562 | **0.653** |
| Mobility | Balanced accuracy | 0.568 | 0.550 | **0.648** |
| AMR cargo | AUROC | 0.746 | 0.785 | **0.835** |
| AMR cargo | AUPRC | 0.697 | 0.700 | **0.828** |
| Expansion | AUROC | 0.867 | 0.838 | **0.872** |
| Expansion | AUPRC | 0.789 | 0.682 | **0.720** |
