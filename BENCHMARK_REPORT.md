...
|---|---:|---:|---:|---:|
| Mobility | Accuracy | 0.5811 | 0.5623 | **0.6830** (+12.0% jump!) |
| Mobility | Balanced accuracy | 0.5682 | 0.5503 | **0.6897** (+13.9% jump!) |
| AMR cargo | AUROC | 0.7463 | 0.7854 | **0.7995** (+1.4% jump!) |
| AMR cargo | AUPRC | 0.6970 | 0.6996 | **0.7685** (+6.8% jump!) |
| AMR cargo | Brier | 0.2104 | 0.1901 | **0.1866** |
| AMR cargo | ECE | 0.2096 | 0.1333 | **0.1306** |
| Expansion | AUROC | 0.8674 | 0.8379 | **0.8875** (+4.9% jump!) |
| Expansion | AUPRC | 0.7886 | 0.6821 | **0.8429** (+16.0% jump!) |
