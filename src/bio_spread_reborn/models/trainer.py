    ...
    def fit(self, train_loader, val_loader):
        ...
        for epoch in range(1, self.epochs + 1):
            ...
            for batch in tqdm(train_loader, desc=f"Epoch {epoch}"):
                # Multi-modal batch: x_gene, x_func, x_history, t, labels
                x_gene, x_func, x_history, t, y = [b.to(self.device) for b in batch]
                
                self.optimizer.zero_grad()
                prob, unc, alpha = self.model(x_gene, x_func, x_history, t)
