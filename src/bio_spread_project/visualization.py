...
def save_table_as_png(headers: list[str], rows: list[list[Any]], title: str, output_path: Path):
...
def plot_performance_summary(metrics: dict[str, Any], output_path: Path):
    ...
    if top_features:
        ...
        bars = ax1.barh(names, scores, color='#339af0', edgecolor='white')
