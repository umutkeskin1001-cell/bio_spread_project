...
- OOF average precision: `0.788`
- Positive prevalence: `0.359`
- Expected calibration error: `0.025`
- Brier score: `0.130`
- Group OOF ROC AUC: `0.875`
- Temporal holdout ROC AUC: `0.945`
- External holdout ROC AUC: `0.746`
- Bootstrap ROC AUC CI: `[0.855, 0.897]`
- Bootstrap AP CI: `[0.735, 0.828]`
