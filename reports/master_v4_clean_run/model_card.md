...
- OOF average precision: `0.822`
- Positive prevalence: `0.359`
- Expected calibration error: `0.021`
- Brier score: `0.120`
- Group OOF ROC AUC: `0.888`
- Temporal holdout ROC AUC: `0.944`
- External holdout ROC AUC: `0.710`
- Bootstrap ROC AUC CI: `[0.867, 0.909]`
- Bootstrap AP CI: `[0.774, 0.853]`
