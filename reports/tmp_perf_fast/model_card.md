...
- OOF average precision: `0.677`
- Positive prevalence: `0.366`
- Expected calibration error: `0.035`
- Brier score: `0.179`
- Group OOF ROC AUC: `0.769`
- Temporal holdout ROC AUC: `0.760`
- External holdout ROC AUC: `0.769`
- Bootstrap ROC AUC CI: `[0.747, 0.796]`
- Bootstrap AP CI: `[0.636, 0.720]`
- Max single-feature AUC: `0.772`
