...
- OOF average precision: `0.818`
- Positive prevalence: `0.366`
- Expected calibration error: `0.146`
- Brier score: `0.195`
- Group OOF ROC AUC: `0.863`
- Temporal holdout ROC AUC: `0.854`
- External holdout ROC AUC: `0.863`
- Bootstrap ROC AUC CI: `[0.863, 0.863]`
- Bootstrap AP CI: `[0.818, 0.818]`
