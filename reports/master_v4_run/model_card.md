...
- OOF average precision: `0.825`
- Positive prevalence: `0.359`
- Expected calibration error: `0.023`
- Brier score: `0.120`
- Group OOF ROC AUC: `0.891`
- Temporal holdout ROC AUC: `0.947`
- External holdout ROC AUC: `0.721`
- Bootstrap ROC AUC CI: `[0.870, 0.911]`
- Bootstrap AP CI: `[0.770, 0.855]`
