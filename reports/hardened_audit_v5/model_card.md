...
- OOF average precision: `0.874`
- Positive prevalence: `0.359`
- Expected calibration error: `0.189`
- Brier score: `0.170`
- Group OOF ROC AUC: `0.915`
- Temporal holdout ROC AUC: `0.915`
- External holdout ROC AUC: `0.773`
- Bootstrap ROC AUC CI: `[0.915, 0.915]`
- Bootstrap AP CI: `[0.874, 0.874]`
