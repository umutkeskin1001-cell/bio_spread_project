...
- OOF average precision: `0.388`
- Positive prevalence: `0.052`
- Expected calibration error: `0.328`
- Brier score: `0.170`
- Group OOF ROC AUC: `0.926`
- Temporal holdout ROC AUC: `0.926`
- External holdout ROC AUC: `0.782`
- Bootstrap ROC AUC CI: `[0.926, 0.926]`
- Bootstrap AP CI: `[0.388, 0.388]`
