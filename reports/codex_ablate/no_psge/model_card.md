...
## Reliability
- OOF ROC AUC: `0.871`
- Minimum AUC target: `0.85`
- OOF average precision: `0.807`
- Positive prevalence: `0.366`
- Expected calibration error: `0.017`
- Brier score: `0.133`
- Group OOF ROC AUC: `0.871`
- Temporal holdout ROC AUC: `0.941`
- External holdout ROC AUC: `0.871`
- Bootstrap ROC AUC CI: `[0.847, 0.893]`
- Bootstrap AP CI: `[0.759, 0.843]`
