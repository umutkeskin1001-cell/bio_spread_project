...
- OOF average precision: `0.817`
- Positive prevalence: `0.366`
- Expected calibration error: `0.023`
- Brier score: `0.125`
- Group OOF ROC AUC: `0.887`
- Temporal holdout ROC AUC: `0.943`
- External holdout ROC AUC: `0.887`
- Bootstrap ROC AUC CI: `[0.861, 0.908]`
- Bootstrap AP CI: `[0.772, 0.855]`
