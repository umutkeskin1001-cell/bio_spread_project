...
- OOF average precision: `0.774`
- Positive prevalence: `0.366`
- Expected calibration error: `0.021`
- Brier score: `0.143`
- Group OOF ROC AUC: `0.854`
- Temporal holdout ROC AUC: `0.899`
- External holdout ROC AUC: `0.854`
- Bootstrap ROC AUC CI: `[0.827, 0.879]`
- Bootstrap AP CI: `[0.728, 0.818]`
