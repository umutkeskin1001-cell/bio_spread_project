...
- OOF average precision: `0.766`
- Positive prevalence: `0.359`
- Expected calibration error: `0.087`
- Brier score: `0.170`
- Group OOF ROC AUC: `0.825`
- Temporal holdout ROC AUC: `0.825`
- External holdout ROC AUC: `0.414`
- Bootstrap ROC AUC CI: `[0.825, 0.825]`
- Bootstrap AP CI: `[0.766, 0.766]`
