...
- OOF average precision: `0.841`
- Positive prevalence: `0.366`
- Expected calibration error: `0.021`
- Brier score: `0.122`
- Group OOF ROC AUC: `0.898`
- Temporal holdout ROC AUC: `0.889`
- External holdout ROC AUC: `0.898`
- Bootstrap ROC AUC CI: `[0.884, 0.912]`
- Bootstrap AP CI: `[0.802, 0.868]`
