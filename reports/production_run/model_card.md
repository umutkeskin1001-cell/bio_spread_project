...
- OOF average precision: `0.763`
- Positive prevalence: `0.359`
- Expected calibration error: `0.095`
- Brier score: `0.163`
- Group OOF ROC AUC: `0.841`
- Temporal holdout ROC AUC: `0.841`
- External holdout ROC AUC: `0.809`
- Bootstrap ROC AUC CI: `[0.841, 0.841]`
- Bootstrap AP CI: `[0.763, 0.763]`
