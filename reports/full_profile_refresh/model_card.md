...
- OOF average precision: `0.845`
- Positive prevalence: `0.366`
- Expected calibration error: `0.016`
- Brier score: `0.121`
- Group OOF ROC AUC: `0.899`
- Temporal holdout ROC AUC: `0.891`
- External holdout ROC AUC: `0.899`
- Bootstrap ROC AUC CI: `[0.884, 0.915]`
- Bootstrap AP CI: `[0.815, 0.870]`
