...
- OOF average precision: `0.850`
- Positive prevalence: `0.366`
- Expected calibration error: `0.042`
- Brier score: `0.119`
- Group OOF ROC AUC: `0.906`
- Temporal holdout ROC AUC: `0.948`
- External holdout ROC AUC: `0.906`
- Bootstrap ROC AUC CI: `[0.885, 0.925]`
- Bootstrap AP CI: `[0.799, 0.881]`
