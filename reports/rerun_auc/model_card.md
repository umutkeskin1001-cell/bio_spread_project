...
- OOF average precision: `0.812`
- Positive prevalence: `0.366`
- Expected calibration error: `0.017`
- Brier score: `0.129`
- Group OOF ROC AUC: `0.882`
- Temporal holdout ROC AUC: `0.875`
- External holdout ROC AUC: `0.882`
- Bootstrap ROC AUC CI: `[0.867, 0.902]`
- Bootstrap AP CI: `[0.776, 0.846]`
