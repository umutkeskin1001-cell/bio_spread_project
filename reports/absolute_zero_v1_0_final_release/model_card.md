...
- OOF average precision: `0.299`
- Positive prevalence: `0.052`
- Expected calibration error: `0.306`
- Brier score: `0.157`
- Group OOF ROC AUC: `0.920`
- Temporal holdout ROC AUC: `0.920`
- External holdout ROC AUC: `0.750`
- Bootstrap ROC AUC CI: `[0.920, 0.920]`
- Bootstrap AP CI: `[0.299, 0.299]`
...
## Explanation Surface
- Top feature signal summary: `genomic_drivers_summary`
