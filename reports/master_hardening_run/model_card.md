...
- OOF average precision: `0.849`
- Positive prevalence: `0.366`
- Expected calibration error: `0.040`
- Brier score: `0.119`
- Group OOF ROC AUC: `0.907`
- Temporal holdout ROC AUC: `0.915`
- External holdout ROC AUC: `0.907`
- Bootstrap ROC AUC CI: `[0.888, 0.926]`
- Bootstrap AP CI: `[0.798, 0.880]`
