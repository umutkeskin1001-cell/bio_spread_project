...
- Brier score: `0.160`
- Group OOF ROC AUC: `0.813`
- Temporal holdout ROC AUC: `0.725`
- External holdout ROC AUC: `0.813`
- Bootstrap ROC AUC CI: `[0.784, 0.839]`
- Bootstrap AP CI: `[0.681, 0.771]`
...
- temporal_holdout_ece_at_most_target: `fail`
