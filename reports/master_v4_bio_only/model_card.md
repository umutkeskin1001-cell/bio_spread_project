...
- OOF average precision: `0.657`
- Positive prevalence: `0.359`
- Expected calibration error: `0.028`
- Brier score: `0.172`
- Group OOF ROC AUC: `0.779`
- Temporal holdout ROC AUC: `0.907`
- External holdout ROC AUC: `0.673`
- Bootstrap ROC AUC CI: `[0.750, 0.804]`
- Bootstrap AP CI: `[0.612, 0.707]`
- Max single-feature AUC: `0.904`
...
- low_knownness_slice_auc_at_least_target: `fail`
- low_knownness_slice_ap_at_least_target: `fail`
- low_knownness_slice_ece_at_most_target: `fail`
